...
- POS Integration: Verify against `.agents/skills/toast/ini-integration-spec.md` schema
- DB Safety: Verify atomic transactions per `.agents/skills/toast/db-safety.md`
- Payment: Verify no raw card data per `.agents/skills/toast/authorize-net.md`
- Loyalty: Verify points calculations per `.agents/skills/toast/loyalty.md`

This ensures project-specific patterns, conventions, database constraints, and best practices are applied during verification.
</project_context>
