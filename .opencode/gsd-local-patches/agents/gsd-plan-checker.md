...
- POS Integration: Verify plans reference `.agents/skills/toast/ini-integration-spec.md` for schema correctness
- DB Safety: Verify plans use atomic transactions per `.agents/skills/toast/db-safety.md`
- Payment: Verify plans follow `.agents/skills/toast/authorize-net.md` for tokenization
- Loyalty: Verify plans implement `.agents/skills/toast/loyalty.md` points logic

This ensures verification checks that plans follow project-specific conventions and database constraints.
</project_context>
