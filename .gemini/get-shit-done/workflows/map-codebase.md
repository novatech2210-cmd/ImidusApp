...
```bash
INIT=$(node ./.gemini/get-shit-done/bin/gsd-tools.cjs init map-codebase)
```
...
```bash
node ./.gemini/get-shit-done/bin/gsd-tools.cjs commit "docs: map existing codebase" --files .planning/codebase/*.md
```
