...
```bash
INIT=$(node ./.gemini/get-shit-done/bin/gsd-tools.cjs init progress)
```
...
- `STATE=$(node ./.gemini/get-shit-done/bin/gsd-tools.cjs state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node ./.gemini/get-shit-done/bin/gsd-tools.cjs summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node ./.gemini/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
