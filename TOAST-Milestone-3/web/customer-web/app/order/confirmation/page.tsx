...
import { ClockIcon, CheckCircleIcon, CalendarIcon } from '@heroicons/react/24/solid';
...
function OrderConfirmationContent() {
  ...
  const scheduledDateTime = scheduledDateTimeParam ? new Date(scheduledDateTimeParam) : null;
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text(isScheduled ? 'Scheduled Order Confirmation' : 'Order Receipt', pageWidth / 2, yPos, { align: 'center' });
    ...
    if (isScheduled) {
      ...
      if (scheduledDateTime) {
        doc.text(`Scheduled Pickup: ${formatScheduledPickup(scheduledDateTime)}`, 20, yPos);
        yPos += 6;
      }
      if (totalFromUrl) {
        doc.text(`Order Total: $${parseFloat(totalFromUrl).toFixed(2)}`, 20, yPos);
        yPos += 6;
      }
      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 mb-6 text-center">
            ...
            <h1 className="mt-4 text-3xl font-bold text-[#1A1A2E]">Scheduled Order Confirmed</h1>
            <p className="mt-2 text-lg text-gray-600">Your order has been scheduled</p>
            ...
            <div className="mt-6 bg-[rgba(212,175,55,0.08)] border-2 border-[rgba(212,175,55,0.3)] rounded-lg p-6">
              <p className="text-sm text-gray-600 uppercase tracking-wide">Pickup Date & Time</p>
              {scheduledDateTime ? (
            ...
            <div className="mt-6 bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-2xl font-mono font-bold text-[#1A1A2E]">{getConfirmationCode()}</p>
            </div>
            ...
            {totalFromUrl && (
              <div className="mt-4">
                ...
                <p className="text-xl font-bold text-[#1E5AA8]">${parseFloat(totalFromUrl).toFixed(2)}</p>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 className="text-lg font-semibold text-[#1A1A2E] mb-4">Important Information</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                <svg className="h-5 w-5 text-[#D4AF37] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sm text-gray-600">
                  <strong>Cancellation Policy:</strong> You can cancel this order up to 2 hours before your scheduled pickup time.
                </p>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-6 text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold text-[#1A1A2E]">Order Confirmed</h1>
          ...
          <div className="mt-6 bg-[rgba(30,90,168,0.08)] border-2 border-[rgba(30,90,168,0.2)] rounded-lg p-6">
            ...
            <p className="mt-2 text-4xl font-bold text-[#1E5AA8]">{pickupTime}</p>
        ...
        <div ref={receiptRef} className="bg-white rounded-lg shadow-md p-8 print:shadow-none">
          ...
          {/* Items */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-[#1A1A2E] mb-3">Order Items</h3>
