...
namespace IntegrationService.API.Constants
{
    public static class ImidusConstants
    {
        ...
        public const string AppMarketingTagline = "Seamless Ordering. Real-Time Sync. Unified Loyalty.";
        public const string SupportEmail     = "support@imidus.com";
        public const string EmailFromAddress = "noreply@imidus.com";
        public const string EmailFromName    = "IMIDUS Technologies";
