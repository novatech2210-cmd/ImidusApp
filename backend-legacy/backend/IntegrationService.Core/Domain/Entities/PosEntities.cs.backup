...
namespace IntegrationService.Core.Domain.Entities
{
    ...
    public class PosTicket
    {
        ...
        public int TransType { get; set; }  // 0=PosTicket, 1=Refund, 2=Void
    ...
    public class PosTicketItem
    {
        ...
        // MenuItem Details (denormalized for speed)
    ...
    /// <summary>
    /// Maps to tblPayment - PosTender tenders
    /// </summary>
    ...
    /// <summary>
    /// Maps to tblCustomer - PosCustomer database
    /// </summary>
