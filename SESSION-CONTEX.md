...
NOTE  "INI_Restaurant database (source of truth) remains the single source of truth for all data."
...
Violating SSOT = Breaking the contract and potentially corrupting the live POS system.
