...
export const getCachedMenu = async (): Promise<{ categories: Category[]; isStale: boolean } | null> => {
  try {
...
export const fetchItemsByCategory = async (categoryId: number): Promise<MenuItem[]> => {
