...
import { Category, MenuAPI, MenuItem } from "@/lib/api";
            ...
            <>
              ...
              <div className="mb-6 flex flex-col md:flex-row md:items-center gap-6">
                {activeCategory?.imageUrl && (
                  <div className="w-full md:w-32 h-32 md:h-24 rounded-2xl overflow-hidden shadow-lg flex-shrink-0">
                    <img
                      src={
                        activeCategory.imageUrl.startsWith("http")
                          ? activeCategory.imageUrl
                          : `http://localhost:5004${activeCategory.imageUrl}`
                      }
