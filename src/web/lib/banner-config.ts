...
export const BANNER_CONFIG: BannerSlide[] = [
  {
    ...
    ctaLink: "/menu",
    bgGradient: "linear-gradient(135deg, #0A1F3D 0%, #174785 100%)",
    segments: ["all", "new"],
    priority: 100,
    active: true,
  },
  {
    ...
    description:
      "Earn 1 point for every $10 spent. Redeem points for discounts on future orders!",
    ctaText: "View Menu",
    ctaLink: "/menu",
  ...
  },
  {
    ...
    description:
      "As a Silver member, you get priority order processing and special seasonal offers.",
    ctaText: "Order Now",
    ctaLink: "/menu",
  ...
  },
  {
    ...
    ctaLink: "/menu",
    bgGradient: "linear-gradient(225deg, #D4AF37 0%, #0A1F3D 100%)",
    segments: ["gold"],
    priority: 95,
    active: true,
  },
  {
    ...
    ctaLink: "/menu",
    bgGradient: "linear-gradient(135deg, #000000 0%, #0A1F3D 100%)",
    segments: ["vip"],
    priority: 100,
    active: true,
  },
  ...
  },
  {
    ...
    description:
      "Real-time order tracking, automatic loyalty points, and seamless pickup. The future of restaurant ordering is here.",
    ctaText: "Learn More",
    ctaLink: "/menu",
...
export function getBannersForSegment(
  ...
  return BANNER_CONFIG.filter((banner) => banner.active)
    .filter(
      (banner) =>
        banner.segments.includes("all") || banner.segments.includes(segment),
    )
