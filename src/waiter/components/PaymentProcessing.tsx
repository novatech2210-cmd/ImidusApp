...
export function PaymentProcessing({ step, error, onRetry, showTimeoutMessage }: PaymentProcessingProps) {
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl p-8 mx-4 max-w-md w-full transform transition-all duration-300 scale-100">
        ...
        <div id="payment-processing-description" className="text-center">
          ...
          {/* Timeout Message */}
          {showTimeoutMessage && step !== 'error' && step !== 'success' && (
            <p className="mt-3 text-sm text-[#D4AF37] font-medium">
